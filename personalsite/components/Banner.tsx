...
export default function Banner() {
  return (
    <section className="space-y-5 [&_p]:text-foreground/75" aria-labelledby="intro-heading">
      ...
      <p>I love programming and building thoughtful Client First Solutions. I also take on <Link href="/freelance">freelance projects</Link> from time to time.</p>
      ...
      <div className="flex items-center gap-3 border-y border-line py-4 [&_a]:border [&_a]:border-line">
        <Link href="https://github.com/EEEDWARD1" aria-label="GitHub" title="GitHub" className="inline-flex size-11 items-center justify-center text-foreground hover:text-foreground hover:opacity-70 focus-visible:outline-2 focus-visible:outline-offset-4">
        ...
        <Link href="https://www.linkedin.com/in/eduardteodor/" aria-label="LinkedIn" title="LinkedIn" className="inline-flex size-11 items-center justify-center text-foreground hover:text-foreground hover:opacity-70 focus-visible:outline-2 focus-visible:outline-offset-4">
          <svg width="24" height="24" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" focusable="false">
